...
class CreateEmoji extends Command {
  ...
  async run(message, args, level) { 
    ...
    if (!image) return message.react('🚫'), message.reply("Command Usage: `create-emoji <IMAGE_URL> <Emoji Name>`");
    ...
    if (!name) return message.react('🚫'), message.channel.send("Command Usage: `create-emoji <IMAGE_URL> <Emoji Name>`");
